    ...
    <center style="width: 100%; background-color: #f1f1f1; ">
        ...
        <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td valign="top" class="bg_white" style="padding: 1em 2.5em 0 2.5em;">
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                            <tr style="border-bottom: 1px solid rgb(216, 216, 216)">
                                <td class="logo" style="text-align: center;">
                                    <h1>
                                        <p style="margin: 0; background: #fff">
                                            <img src="{{ $message->embed(public_path() . '/assets/images/logo-dark.png') }}"
                                                width="55%">
                                            <br>
                                        </p>
                                    </h1>
                ...
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="padding: 2em 0 4em 0; padding-bottom: 0; margin-top: 8px;">
            ...
            {{-- <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="text-align: left; padding: 2px">
                                                ...
                                                <ul>
                                                    <li>
                                                        <span class="text">Call:<br>+23324 391 3077</span>
                                                        <br><br>
                                                        <span>Website:<br>www.gitplus.app</span>
                                                        <br><br>
                                                        <span class="text">
                                                            Address:<br>
                ...
                {{-- <tr>
                    <td class="bg_light" style="text-align: center; color: #000; background: #f0a606; padding: 8px">
                        <p style="padding: 10px">ZinkerCARD is the only card that allows you to take care of yourself
                            whiles making significant savings!
                        </p>
                    </td>
                </tr>
                <tr>
                    <td class="bg_light" style="text-align: center; background: rgb(0, 0, 0); color: #eee">
