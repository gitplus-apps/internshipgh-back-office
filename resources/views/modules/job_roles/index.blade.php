                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="display-8">JOB ROLES</h2>
                                

                                <table id="job_roles-table" class="table table-striped dt-responsive nowrap"
...
@push('scripts')
    <script>
        // GET ITEM
        var rolesTable = $('#job_roles-table').DataTable({
            dom: "Bfrtip",
            ajax: {
             
                url: `${APP_URL}/api/job_roles`,
                type: "GET",
