                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="display-8">PROGRAMMES</h2>
                                

                                <table id="programs-table" class="table table-striped dt-responsive nowrap"
...
@push('scripts')
    <script>
        // GET ITEM
        var programsTable = $('#programs-table').DataTable({
            dom: "Bfrtip",
            ajax: {
             
                url: `${APP_URL}/api/programs`,
                type: "GET",
