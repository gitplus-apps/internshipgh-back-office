                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="display-7">DISTRICTS</h2>
                                

                                <table id="districts-table" class="table table-striped dt-responsive nowrap"
...
@push('scripts')
    <script>
        // GET ITEM
        var districtsTable = $('#districts-table').DataTable({
            dom: "Bfrtip",
            ajax: {
             
                url: `${APP_URL}/api/districts`,
                type: "GET",
