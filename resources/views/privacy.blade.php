    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 content">
                ...
                <p>
                    At Internship Ghana, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your personal data. By using or accessing our Services in any manner, you acknowledge that you accept the practices and policies outlined below, and you hereby consent that we will collect, use and share your information as described in this Privacy Policy.
                </p>
                <p>
                    Remember that your use of our Services is at all times subject to our <a href="{{url('/terms-of-use')}}">Terms of Use </a>, which incorporates this Privacy Policy. Any terms we use in this Policy without defining them have the definitions given to them in the Terms of Use.
                 </p>
                ...
                <h5>Profile or Contact Data</h5>

                <h6>Examples include</h6>
                ...
                <ul>
                    ...
                    <li>Other unique personal or online identifiers including school identifiers</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Credit or debit card number (full number)</li>
                    <li>Billing zip code</li>
                </ul>
                
                <h5>Device/IP Data</h5>
                <ul>
                    <li>IP address </li>
                    <li>Device ID</li>
                ...
                <ul>
                    ...
                    <ul>
                        ...
                        <h5>Our Commercial or Business Purposes for Collecting Personal Data</h5>
                        <h6>Providing, Customizing and Improving the Services</h6>
                        <ul>
                        ...
                        <h5>Corresponding with You</h5>
                        <ul>
                            <li>Responding to correspondence that we receive from you, contacting you when necessary or requested, and sending you information about Internship Ghana or the Services.</li>
                        ...
                        <h5>Meeting Legal Requirements and Enforcing Legal Terms</h5>
                        <ul>
                            ...
                            <li>Protecting the rights, property or safety of you, Internship Ghana or another party.</li>
                        ...
                        <h5>Data Sharing</h5>
                        <p>We DO NOT disclose or share your Personal Data with any third party.</p>

                        <h5>Data that is Not Personal Data</h5>
                        ...
                        <p>
                        We’re constantly trying to improve our Services, so we may need to change this Privacy Policy from time to time, but we will alert you to any such changes by placing a notice on the Internship Ghana website, by sending you an email and/or by some other means.
                        </p>
                        <p>                        
                        ...
                        <span>Internship Ghana – Privacy</span><br>
                        <span>Accra Digital Center</span><br>
                        <span>Kwame Nkrumah Circle</span><br>
                        <span>John Dramani Mahama Block</span><br>
