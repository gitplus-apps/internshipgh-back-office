                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="display-8">SCHOOLS</h2>
                                

                                <table id="schools-table" class="table table-striped dt-responsive nowrap table-hover"
...
@push('scripts')
    <script>
        // GET ITEM
        var schoolsTable = $('#schools-table').DataTable({
            dom: "Bfrtip",
            ajax: {
             
                url: `${APP_URL}/api/schools`,
                type: "GET",
